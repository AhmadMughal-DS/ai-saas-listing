  ...
  return (
    <div className="w-full pt-28 pb-24 px-4 sm:px-8 max-w-[1440px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs font-semibold uppercase tracking-wide mb-3 shadow-xs">
            <Database className="w-3.5 h-3.5 text-indigo-600" />
            <span>AIFlux Database Administration & MongoDB Pipeline</span>
          </div>
